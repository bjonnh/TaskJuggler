...
class TaskJuggler
    ...
    def eval(expr)
      ...
      when '>', '>=', '=', '<', '<=', '!='
        ...
        if opnd1.is_a?(TjTime)
          ...
          return res
        elsif opnd1.is_a?(Integer) || opnd1.is_a?(Float) || opnd1.is_a?(Integer)
  ...
  private
    ...
    def coerceBoolean(val, expr)
      ...
      return val != 0 if val.is_a?(Integer) || val.is_a?(Integer)
    ...
    def coerceNumber(val, expr)
      unless val.is_a?(Integer) || val.is_a?(Float) || val.is_a?(Integer)
